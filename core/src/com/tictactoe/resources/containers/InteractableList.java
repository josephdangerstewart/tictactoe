package com.tictactoe.resources.containers;

import com.badlogic.gdx.Input;
import com.badlogic.gdx.graphics.g2d.Sprite;
import com.badlogic.gdx.graphics.g2d.SpriteBatch;
import com.tictactoe.resources.components.NumberTextField;
import com.tictactoe.resources.components.TextField;
import com.tictactoe.resources.meta.InteractiveContainer;
import com.tictactoe.resources.meta.InteractiveDrawable;
	...
	public boolean keyDown(int keyCode) {
		...
		if (keyCode == Input.Keys.TAB) {
			for (int i = 0; i < list.size(); i ++) {
				...
				if (list.get(i).getClass().getCanonicalName().equals("com.tictactoe.resources.components.TextField")) {
					((TextField)list.get(i)).click();
					System.out.println("TextField!!!");
					return true;
				} else if (list.get(i).getClass().getCanonicalName().equals("com.tictactoe.resources.components.NumberTextField")) {
