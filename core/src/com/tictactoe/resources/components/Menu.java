...
import com.tictactoe.resources.meta.MenuEvent;
...
public class Menu extends InteractiveDrawable {
    ...
    public void setData(String background, String fontFile, String title,
        ...
        x = TicTacToeMain.WIDTH/2 - (int)(this.background.getWidth()/2);
        y = TicTacToeMain.HEIGHT/2 - (int)(this.background.getHeight()/2);
        this.background.setPosition(x,y);
    }
